...
public class GUIManager {
    ...
    public GUIManager(long window) {
        win = window;
        byte[] bytes = Filesystem.getFileBytesFromResourceDirectory(getClass(), "/Fonts/FiraCode-Regular.ttf");
        this.ttf = BufferUtils.createByteBuffer(bytes.length);
        this.ttf.put(bytes);
        this.ttf.flip();
    }
