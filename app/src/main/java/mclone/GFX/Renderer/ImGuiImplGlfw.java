...
public class ImGuiImplGlfw {
    ...
    private boolean shouldApplyInput = true;
    protected void setShouldApplyInput(boolean apply) { shouldApplyInput = apply; }
    protected boolean getShouldApplyInput() { return shouldApplyInput; }
