...
import juliet.ECS.*;
import juliet.GFX.OpenGL.FrameBuffer;
import juliet.GFX.OpenGL.GraphicsAPI;
import juliet.GFX.Renderer.FPSCameraController;
import juliet.GFX.Renderer.Model;
import juliet.GFX.Renderer.Renderer;
...
public class Editor {
    ...
    public void init() {
        mainWindow = new Window("juliet Editor", 900, 600, false);
